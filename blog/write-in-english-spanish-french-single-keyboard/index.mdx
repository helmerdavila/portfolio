...
<GatsbyImage image={getImage(props.localImages[1])} alt="Windows" />
<GatsbyImage image={getImage(props.localImages[2])} alt="Windows" />

### Linux Mint configuration

<GatsbyImage image={getImage(props.localImages[3])} alt="Windows" />
...
> You can press the letter and the symbol then and it will work. E.g Super + n + ~ = ñ
