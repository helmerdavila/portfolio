...
tags: ['livres', 'management', 'leadership']
---
...
As-tu été promu de programmeur à _Tech lead_? As-tu un nouveau projet et tu diriges une équipe? Tu ne sais pas comment organiser une équipe technique? Ce livre t’aidera à résoudre plusieurs des questions lorsque tu as un leadership technique et ton travail passe de la création de code à l'établissement de relations avec tes collègues.
