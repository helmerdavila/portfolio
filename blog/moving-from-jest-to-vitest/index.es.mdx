...
Pero, si quieres seguir utilizando React Test Utils, trabajar con React y tener **\*\*\*\***coverage**\*\*\*\*** de código, instala las siguientes librerías a continuación
...
- `coverage`, donde puedes especificar los formatos de reporte de la herramienta de **\*\*\*\***coverage**\*\*\*\***.
...
Para 74 tests que tengo el día que estoy escribiendo esto, la diferencia entre entre Jest y Vitest es sólo de 1 segundo, donde Vitest es el ganador. No se ve como mucho, pero cuando la cantidad de tus tests comienza a incrementarse, la diferencia se incrementará, por supuesto.
