...
Bad luck, [the plugin that I used](https://github.com/ArtiomTr/jest-coverage-report-action) to create a report of my coverage is not compatible with Vitest. I hope in the future I will be able to find a similar one, as I have no time to create a fork and modify it.
