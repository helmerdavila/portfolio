...
But in the current mobile flow, I have different screens for execute a specific task. The goal of a custom iPad screen is to put a list (HTTP requests in this case) to the left and the content screen to the right.
