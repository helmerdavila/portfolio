...
imageAlt: 'Tmux'
tags: ['tools', 'macos', 'tmux', 'terminal', 'shell', 'bash']
---
...
C’est le jour pour configurer mon nouveau Mac. Après que j’ai fini l’installation de mon profil Tmux avec tous les plugiciels que j’en ai besoin. Le raccourci Ctrl-Space n’a fonctionné pas. J’ai essayé la même commande sur tous mes terminaux \*\*qui j’ai: Kitty, Alacritty et Terminal.app.
